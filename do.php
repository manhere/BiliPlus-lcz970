...
<div><br/></div><div class="hrdescription">视频源文件</div><hr><div class="videofile"><div class="infolist">视频总长：'.$videolength.'</div><br/><fieldset><legend>源视频文件</legend><div class="tip">请按顺序下载所有分段获得完整视频</div>'.$video.'</fieldset><fieldset><legend>合并+转码MP4</legend><div class="tip">视频质量可能有轻微下降，部分投稿无法提供MP4下载</div>';
	    if (stristr($getmp4['from'],'local'))
		echo '<a href="'.$videomp4.'" target="_blank" title="下载合并分段标清MP4格式视频文件"><div class="filelist">MP4视频下载 [标清]</div></a><div class="infolist">来源:哔哩哔哩云转码</div>';
	    ...
	    if (stristr($getmp4['from'],'letv_auto'))
		echo '<a href="'.$videomp4.'" target="_blank" title="下载合并分段标清MP4格式视频文件"><div class="filelist">MP4视频下载 [标清]</div></a><div class="infolist">来源:乐视云转码</div>';
	    ...
	    if (stristr($getmp4['from'],'bilibili_high'))
	    ...
	    if (stristr($getmp4['from'],'bilibili_auto'))
	    ...
	    if (stristr($getmp4['from'],'bilibili_low'))
