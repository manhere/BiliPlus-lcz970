	...
	<fieldset>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td width="120px" align="right">
                    <select name="n" style="width:90%"><option value="5">5个/页</option><option value="10">10个/页</option><option value="20" selected="selected">20个/页</option><option value="30">30个/页</option><option value="50">50个/页</option></select>
                </td>
            </tr>
            <tr>
                <td align="center">
